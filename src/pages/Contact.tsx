    ...
    <div className="min-h-screen">
      ...
      <section className="pt-24 pb-8">
        <div className="container mx-auto max-w-7xl px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gradient">Kontakt</h1>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-lg font-semibold hover:text-accent transition-all duration-200 hover:translate-x-1 inline-block group"
                      >
                        +420 725 005 725
                      </a>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-lg font-semibold hover:text-accent transition-all duration-200 hover:translate-x-1 inline-block break-all"
                      >
                        ski@kohutka.ski
                      </a>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <a
                          ...
                          className="text-lg font-semibold hover:text-accent transition-all duration-200 hover:translate-x-1 inline-block"
                        >
                          +420 571 160 800
                        </a>
                      </div>
              ...
              <Card className="glass p-6 border-white/20 rounded-lg">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold group-hover:text-accent transition-colors">Facebook</p>
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold group-hover:text-accent transition-colors">Instagram</p>
